        ...
        <>
            ...
            <section className="text-gray-600 body-font min-h-screen">
                <div className="container w-[92%] px-5 py-12 mx-auto">
                    <h1 className="text-xl md:text-2xl text-black font-bold font-serif text-center pb-4 border-b-[1px] border-gray-400">Decorate Your World: Browse Our Range of Stickers</h1>
