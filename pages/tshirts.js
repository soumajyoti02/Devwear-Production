        ...
        <>
            ...
            <section className="text-gray-600 body-font min-h-screen">
                <div className="container w-[92%] px-5 py-12 mx-auto">
                    <h1 className="text-xl md:text-2xl text-black font-bold font-serif text-center pb-4 border-b-[1px] border-gray-400">Upgrade Your Wardrobe with Our Trendy T-Shirts</h1>
                            ...
                            return <Link passHref={true} key={products[item]._id} href={`/product/${products[item].slug}`} className='lg:w-1/5 md:w-1/2 p-4 w-full shadow-lg m-5'>
                                <div className="">
                                    <div className=" relative  rounded overflow-hidden">
                                        <img alt="T-Shirt Image" className="m-auto  h-[30vh] md:h-[36vh] block" src={products[item].img} />
                                    </div>
