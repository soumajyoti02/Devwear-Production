    ...
    return (
        <>
            <div className='container mx-auto my-9 w-11/12'>
                ...
                <h2 className="text-xl font-bold mt-7">1. Delivery Details</h2>
                ...
                <div className="mx-auto flex flex-wrap justify-center md:justify-normal">
                    ...
                    <button onClick={handleUserSubmit} className="disabled:bg-slate-300  flex justify-center items-center mx-2 text-white bg-slate-700 border-0 py-2 px-[0.7rem] focus:outline-none hover:bg-slate-900 rounded text-sm w-8/12 md:w-24 m-auto font-semibold">Submit</button>
                </div>


                <h2 className="text-xl font-bold mt-7">2. Change Password</h2>
                <div className="mx-auto flex flex-wrap justify-center md:justify-normal">
                    <div className="px-2 w-full md:w-1/2">
                        <div className=" mb-4">
                    ...
                    <button onClick={handlePasswordSubmit} className="disabled:bg-slate-300  flex justify-center items-center mx-2 text-white bg-slate-700 border-0 py-2 px-[0.7rem] focus:outline-none hover:bg-slate-900 rounded text-sm w-8/12 md:w-24 m-auto font-semibold">Change Password</button>
                </div>
